 ...
 * version: 1.0
 */
public class Children2CallbackTest extends BaseTest implements AsyncCallback.Children2Callback {
    ...
    public void processResult(int rc, String path, Object ctx, List<String> children, Stat stat) {
        ...
        System.out.printf("get children in the %s,  result: %s, %s, %s%n%s%n%n"
                , path, stat.getCzxid(), stat.getMzxid(), stat.getPzxid(), children);
    }
}
